import { useGetContratosQuery } from "../services/apiTable"
import { useSelector } from "react-redux"
import Tables from "./Tables"

export default function Contratos() {
    let getColumns = useSelector(state => state.colTable.columns['contratos']);
    const actiones = {
        name: 'Acciones',
        cell: row => (
            ...
            <div className=' flex  gap-2'>
                ...
                <button title='Editar' onClick={null}>
                ...
                <button title='Eliminar' onClick={null}>
    ...
    const { data, isSuccess } = useGetContratosQuery()
    return (
        <>
            {
                isSuccess &&
                <Tables data={data} columns={columns} name={'Contratos'} />
            }
        </>
    )
}