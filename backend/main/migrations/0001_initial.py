# Generated by Django 5.0.3 on 2024-03-20 01:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='contrato',
            name='producto',
            field=models.ManyToManyField(related_name='contrato', to='main.producto'),
        ),
        migrations.CreateModel(
            name='Suministrador',
            fields=[
        ...
        migrations.AddField(
            model_name='contrato',
            name='suministrador',
            field=models.ManyToManyField(related_name='contratos', to='main.suministrador'),
        ),
        migrations.CreateModel(
            name='Abogado',
            fields=[
        ...
        migrations.AddField(
            model_name='contrato',
            name='comercial',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contratos', to='main.comercial'),
        ),
        migrations.CreateModel(
            name='Compra',
            fields=[
                ...
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='compras', to='main.producto')),
                ('suministrador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='compras', to='main.suministrador')),
